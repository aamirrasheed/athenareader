          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
              ...
              <div className="flex-grow text-left mt-6 sm:mt-0">
                <h2 className="text-xl text-center sm:text-left title-font font-medium mb-2">Cut out the never-ending now.</h2>
            ...
            <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
              ...
              <div className="flex-grow text-left mt-6 sm:mt-0">
                <h2 className="text-xl title-font text-center sm:text-left font-medium mb-2">Learn from the best minds on the internet.</h2>
                <ul>
            ...
            <div className="flex items-center lg:w-3/5 mx-auto  sm:flex-row flex-col">
              ...
              <div className="flex-grow text-left mt-6 sm:mt-0">
                <h2 className="text-xl text-center sm:text-left mtitle-font font-medium mb-2">Take control of your information diet.</h2>
            ...
            <Button
                className="flex mx-auto mt-10 py-2 px-10 xl:w-1/4 lg:w-1/3 w-2/3 text-lg bg-purple-500 text-white hover:bg-purple-1000"
                size="lg"
                href="/login"
                as={Link}
            >
